  ...
  return (
    <Fragment>
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative bg-cover bg-center" style={{ backgroundImage: "url('./images/errorImages/403AccessDenied.webp')" }}>
          {/* Logo */}
        ...
        {/* Right Column - 401 Content */}
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full space-y-8 text-center">
            {/* Error Content */}
            <div className='space-y-4'>
              <h1 className="text-6xl font-bold text-gray-900">
                4<span className='text-primary'>0</span>1
              </h1>
              <h2 className="text-2xl font-bold text-gray-900">
                Unauthorized Access
              </h2>
              <p className="text-gray-600">
                You don't have permission to access this page. Please log in with the correct credentials.
              </p>
            </div>
