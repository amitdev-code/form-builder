...
export const ThankYouSlide: React.FC = () => {
    ...
    // Check if the selected slide is actually a thankyou type slide
    if (!currentSlide || currentSlide.type !== 'thankyou') {
        return (
            <div className="min-h-[525px] flex items-center justify-center">
                <div className="text-center text-gray-500">
                    <p>No thank you slide selected</p>
                </div>
            </div>
        );
    }
            ...
            return (
                ...
                >
                    <div className="w-full max-w-4xl text-center flex flex-col items-center justify-center">
                        {/* Render thank you slide content */}
                        {
                        ...
                        <div className="w-full flex items-center justify-center">
                            {formSettings.navigation.navigationLayout === 'floating' && currentSlide.type != 'thankyou' && <NavigationMenu />}
                        </div>
                    </div>
                </div>
            )
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                style={textStyle}
                                                dangerouslySetInnerHTML={{ __html: item.text_design?.text || 'Thank you for your response' }}
                                            >
